...
object AppConfig {
    ...
    const val ANG_PACKAGE = pey.vpn.net.BuildConfig.APPLICATION_ID
    ...
    /** Broadcast actions. */
    const val BROADCAST_ACTION_SERVICE = "pey.v2hub.net.action.service"
    const val BROADCAST_ACTION_ACTIVITY = "pey.v2hub.netaction.activity"
    const val BROADCAST_ACTION_WIDGET_CLICK = "pey.v2hub.net.action.widget.click"
