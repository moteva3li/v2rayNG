...
import pey.vpn.net.AppConfig.SUBSCRIPTION_UPDATE_CHANNEL
import pey.vpn.net.AppConfig.SUBSCRIPTION_UPDATE_CHANNEL_NAME
import pey.vpn.net.R
import pey.vpn.net.handler.AngConfigManager.updateConfigViaSub
