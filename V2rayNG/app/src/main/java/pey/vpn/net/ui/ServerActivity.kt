...
import pey.vpn.net.AppConfig.DEFAULT_PORT
import pey.vpn.net.AppConfig.PREF_ALLOW_INSECURE
import pey.vpn.net.AppConfig.REALITY
import pey.vpn.net.AppConfig.TLS
import pey.vpn.net.AppConfig.WIREGUARD_LOCAL_ADDRESS_V4
import pey.vpn.net.AppConfig.WIREGUARD_LOCAL_ADDRESS_V6
import pey.vpn.net.AppConfig.WIREGUARD_LOCAL_MTU
