...
import pey.vpn.net.dto.Language
...
object Utils {
    ...
    fun getUrlContentWithCustomUserAgent(
        ...
        conn.readTimeout = timeout
        conn.setRequestProperty("Connection", "close")
        conn.setRequestProperty("User-agent", "v2rayNG/${pey.vpn.net.BuildConfig.VERSION_NAME}")
        url.userInfo?.let {
    ...
    fun isXray(): Boolean = (ANG_PACKAGE.startsWith("pey.vpn.net.ang"))
